  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: '#F4F4F4', paddingBottom: '52px' }}>
      ...
      <section className="pt-16 relative overflow-hidden" style={{ minHeight: '95vh' }}>
        ...
        <div className="relative z-10 flex flex-col md:grid md:grid-cols-12" style={{ minHeight: 'calc(95vh - 4rem)' }}>
          {/* Image panel */}
          <div className="md:col-span-5 relative flex" style={{ borderBottom: '4px solid #000', borderRight: undefined, minHeight: '300px' }}
            ref={el => { if (el) { if (window.innerWidth >= 768) { el.style.borderRight = '4px solid #000'; el.style.borderBottom = 'none'; } } }}>
            <div className="w-full overflow-hidden" style={{ margin: '1rem', border: '4px solid #000' }}>
              <img src="/images/a..2.creative images for sections/dark fasion girl.png"
                alt="Streetwear" className="w-full h-full object-cover object-top" style={{ display: 'block', filter: 'contrast(1.08)', minHeight: '260px' }} />
            </div>
          </div>

          {/* Text panel */}
          <div className="md:col-span-7 flex flex-col justify-center px-6 md:px-16 py-10 md:py-14 relative">
      ...
      <div style={{ position: 'relative', height: '100px', overflow: 'hidden', borderTop: '4px solid #000', borderBottom: '4px solid #000' }}>
        <img src="/images/a.1.abstract art background/download (21).jpg" alt=""
      ...
      {/* ── EDITORIAL SPOTLIGHT ── mobile: stacked, desktop: 2-col */}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2" style={{ borderTop: '4px solid #000' }}>
        <div className="relative overflow-hidden" style={{ minHeight: '300px', borderBottom: '4px solid #000' }}>
          <img src="/images/a..2.creative images for sections/bright genz boy.png"
            alt="Your generation is ready"
            className="w-full h-full object-cover object-top"
            style={{ display: 'block', minHeight: '300px', filter: 'contrast(1.08)' }} />
            ...
            <div style={{ position: 'relative', zIndex: 1, padding: '32px 28px', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
              {[['12', 'NAIROBI SCHOOLS'], ['340+', 'ACTIVE MEMBERS'], ['47', 'COUNTY REPS'], ['100%', 'TEEN-WRITTEN']].map(([num, label], i) => (
                <div key={label} style={{ display: 'flex', alignItems: 'center', gap: '20px', paddingTop: '14px', paddingBottom: '14px', borderBottom: i < 3 ? '1px solid rgba(255,255,255,0.12)' : 'none' }}>
                  <span style={{ fontFamily: ANTON, fontSize: 'clamp(1.6rem,3.5vw,3rem)', color: '#fff', lineHeight: 1, minWidth: '90px' }}>{num}</span>
